...
<?= $this->section('content') ?>
    ...
    <h1 class="mb-4 text-warning"><i class="bi bi-pencil-square"></i> <?= $titulo ?>: <span class="text-secondary"><?= $profesor['nombre'] ?> <?= $profesor['apellido'] ?></span></h1>
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            <form action="<?= base_url('profesores/actualizar') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="dni" name="dni" class="form-control" 
                               value="<?= old('dni', $profesor['dni']) ?>" required>
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-warning text-dark">
                        <i class="bi bi-arrow-up-circle"></i> Actualizar Profesor
                    </button>
                </div>
            </form>
        </div>
