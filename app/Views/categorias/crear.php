            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Complete el formulario para registrar una nueva categoría</p>
                    </div>
                </div>
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-primary text-white py-3">
                        <h5 class="card-title mb-0">
                            <i class="bi bi-info-circle me-2"></i>Detalles de la Categoría
                        </h5>
                    </div>
                        ...
                        <form action="<?= base_url('categorias/guardar') ?>" method="post">
                            ...
                            <div class="mb-4">
                                <label for="nombre" class="form-label fw-semibold">
                                    <i class="bi bi-fonts me-1 text-primary"></i>Nombre de la Categoría
                                </label>
